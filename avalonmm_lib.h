...
/* TODO: The values specified here will be used if not overidden
         by assignments in the CMakeLists.txt file. */

#ifndef AVALONMM_DEFAULT_VENDOR_ID
#define AVALONMM_DEFAULT_VENDOR_ID 0x1172
#endif

#ifndef AVALONMM_DEFAULT_DEVICE_ID
#define AVALONMM_DEFAULT_DEVICE_ID 0xE003
#endif
